...
magic.exe: magic/magic.o magic/string_utils.o magic/input_utils.o magic/sort_utils.o
	gcc -ansi -Wall -pedantic -o magic.exe magic/magic.o magic/string_utils.o magic/input_utils.o magic/sort_utils.o
